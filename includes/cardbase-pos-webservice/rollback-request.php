...
class RollbackRequest
{
    ...
    public function __construct($card_number, $card_verification_code, $merchant_id, $secret_key, $original_request_id)
    {
        ...
        // Create hash
        $string_to_hash = $merchant_id.$this->request_id.$card_number.$card_verification_code.$this->original_request_id.$this->remark.$secret_key;
    ...
    {
        return "http://ws.tcs-cms.nl/wsdl/pointofsale/v4/IGiftcard/Rollback";
    }
        ...
        <soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:v4="http://ws.tcs-cms.nl/wsdl/pointofsale/v4">
            ...
            <soap:Body>
                <v4:RollbackRequest>
                    ...
                    <v4:OriginalRequestID><?php echo $this->original_request_id ?></v4:OriginalRequestID>
                    <!--Optional:-->
                    <v4:Remark><?php echo $this->remark ?></v4:Remark>
                    <!--Optional:-->
                    <v4:TransactionTag><?php echo $this->transaction_tag ?></v4:TransactionTag>
                </v4:RollbackRequest>
            </soap:Body>
        </soap:Envelope>
        <?php
